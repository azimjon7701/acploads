(function($, window, document, undefined) {
    ...
    function CubePortfolio(obj, options, callback) {
        ...
        // used by the filters plugin. remove from here and create proper API with position for plugins
    ...
    $.extend(CubePortfolio.prototype, {
        storeData: function(blocks, indexStart) {
            ...
            blocks.each(function(index, el) {
                ...
                item.data('cbp', {
                    ...
                    width: width, // used by drag & drop wp @ maybe I will use widthAndGap
                    height: height,
        ...
        addItems: function(items, callback, position) {
            ...
            if (CubePortfolio.private.modernBrowser) {
                ...
                t.addItemsFinish(items, callback); // @ on ie8 & ie9 callback triggers to early
            }
        ...
        removeItems: function (items, callback) {
            ...
            if (CubePortfolio.private.modernBrowser) {
                ...
                t.removeItemsFinish(items, callback); //  on ie8 & ie9 callback triggers to early
            }
